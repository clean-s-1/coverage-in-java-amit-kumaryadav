...
**Now I used to think about clean code and testability of the code, consecutive complexity, naming convention and readability of the code. Still need improvement from my side but It's helped a lot.**
